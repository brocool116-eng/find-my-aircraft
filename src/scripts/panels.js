function showFlightPanel(aircraft) {
  ...
  document.getElementById('panel-altitude').textContent = aircraft.altitude ?? '-';
...
function initPanels() {
  const popups = { 'btn-settings': 'settings-popup', 'btn-weather': 'weather-popup', 'btn-filters': 'filters-popup' };
